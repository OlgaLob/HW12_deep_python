...
class Student:
    ...
    def subject_test_average(self, subject):
        return subject, round(sum(self.subject_tests[subject]) / len(self.subject_tests[subject]), 2)


student = Student("Olga Nick Lo")

student.add_score(4, 'Biology')
student.add_score(5, 'Math')
student.add_score(5, 'Russian')

student.add_test_result(80, 'Math')
student.add_test_result(90, 'French')
student.add_test_result(20, 'Russian')
student.add_test_result(65, 'Russian')


print("Средний балл по оценкам", student.average_score_student())


print("Средний балл по тестам:", student.subject_test_average('Russian'))
